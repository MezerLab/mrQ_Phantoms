...
function T1ScanExperiment_phantom(...
...
switch method
  ...
  case{'RD-NLS-PR'}
    data = data; %%origanly data = abs(data);
    nbrOfFitParams = 4; % Number of output arguments for the fit
    fitStr = ['[T1Est bMagEst aMagEst res] = rdNls_phantom(data(jj,:),nlsS);']
