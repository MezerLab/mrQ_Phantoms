...
function [T1Hat, bHat, aHat, residual] = rdNls_phantom(data, nlsS)
...
right_sign=SEIR_invert_sigh(data,nlsS.tVec);%find the right sign
data=abs(data);%%abs to data

data=data.*right_sign;%% correction for sign
