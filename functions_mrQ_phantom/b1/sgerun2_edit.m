function sgerun2_edit(command,name,wantworkspace,jobindices,priority,flags,memusage)
...
% internal constants
masterdir = '/cluster/Mezer/oshrat.shtangel/for_sge/sgeoutput/';
masterscript = '/cluster/Mezer/oshrat.shtangel/for_sge/matlabsge.sh';
...
echocmd = sprintf('echo "%s" > /cluster/Mezer/oshrat.shtangel/for_sge/sgeoutput/%s.command; ',qsubcmd,name);
